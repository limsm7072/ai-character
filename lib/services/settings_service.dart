...
class SettingsService {
  ...
  static const defaultDashboardOrder = ['recommend', 'fortune', 'psychology', 'screentime', 'activity', 'news', 'weather', 'routine', 'todo', 'goal', 'diary', 'card', 'calendar', 'stats', 'alarm', 'timer', 'memo', 'dday', 'nature', 'bookmark', 'notion'];
  ...
  static const _defaultLargeSections = {'recommend', 'fortune', 'psychology', 'screentime', 'activity', 'news', 'weather', 'routine', 'todo', 'goal', 'diary', 'card', 'calendar', 'stats', 'alarm', 'timer', 'memo', 'dday', 'nature', 'bookmark', 'notion'};
